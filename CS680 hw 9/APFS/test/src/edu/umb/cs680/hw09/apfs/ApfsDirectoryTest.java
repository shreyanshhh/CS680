...
class ApfsDirectoryTest {
	...
	public void verifyApfsDirectoryEqualityHome() {
		APFS fileSystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) fileSystemApfs.getRootDir();
		String[] expected = {"true", "home", "0", localTime.toString(), "root", "3150", "4", "Shreyansh", localTime.toString()};
	...
	public void verifyApfsDirectoryEqualityApplications() {
		APFS fileSystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) fileSystemApfs.getRootDir();
		String[] expected = {"true", "applications", "0", localTime.toString(), "root", "350", "1", "Shreyansh", localTime.toString()};
	...
	public void verifyApfsDirectoryEqualityCode() {
		APFS fileSystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) fileSystemApfs.getRootDir();
		String[] expected = {"true", "code", "0", localTime.toString(), "home", "880", "3", "Shreyansh", localTime.toString()};
