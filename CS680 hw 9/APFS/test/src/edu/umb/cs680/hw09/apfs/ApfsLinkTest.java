...
static LocalDateTime localTime = LocalDateTime.now();
	...
	public void verifyLinkEqualityX() {
		...
		String[] expected = {"false", "x", "0", localTime.toString(), "home", "Shreyansh", localTime.toString(), "applications"};
	...
	public void verifyLinkEqualityY() {
		APFS fileSystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory) fileSystemApfs.getRootDir();
		String[] expected = {"false", "y", "0", localTime.toString(), "code", "Shreyansh", localTime.toString(), "a"};
