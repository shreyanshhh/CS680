...
class ApfsFileTest {
	...
	public void verifyApfsFileEqualityA() {
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)FilesystemApfs.getRootDir();
		String[] expected = {"false", "a", "350", localTime.toString(), "applications", "Shreyansh", localTime.toString()};
	...
	public void verifyApfsFileEqualityB() {
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)FilesystemApfs.getRootDir();
		String[] expected = {"false", "b", "700", localTime.toString(), "home", "Shreyansh", localTime.toString()};
		//System.out.println(root.findFileByName("a").getParent().getName());
	...
	public void verifyApfsFileEqualityC() {
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)FilesystemApfs.getRootDir();
		String[] expected = {"false", "c", "800", localTime.toString(), "code", "Shreyansh", localTime.toString()};
		//System.out.println(root.findFileByName("a").getParent().getName());
	...
	public void verifyApfsFileEqualityD() {
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)FilesystemApfs.getRootDir();
		String[] expected = {"false", "d", "80", localTime.toString(), "code", "Shreyansh", localTime.toString()};
		//System.out.println(root.findFileByName("a").getParent().getName());
	...
	public void verifyApfsFileEqualityE() {
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)FilesystemApfs.getRootDir();
		String[] expected = {"false", "e", "700", localTime.toString(), "pics", "Shreyansh", localTime.toString()};
		//System.out.println(root.findFileByName("a").getParent().getName());
	...
	public void verifyApfsFileEqualityF() {
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)FilesystemApfs.getRootDir();
		String[] expected = {"false", "f", "870", localTime.toString(), "pics", "Shreyansh", localTime.toString()};
		//System.out.println(root.findFileByName("a").getParent().getName());
