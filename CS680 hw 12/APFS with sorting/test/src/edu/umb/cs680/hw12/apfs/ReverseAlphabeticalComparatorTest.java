...
class ReverseAlphabeticalComparatorTest {
	...
	public static void setUpFileStructure() {
		...
		ApfsFile g = new ApfsFile(home, "g", 1, localTime, "Shreyansh", localTime);
	...
	public void ChildrenHomeDiretoryComparatorTest() {
		...
		String[] actual = ApfsEleToString((LinkedList<ApfsElement>) root.findDirectoryByName("home").getChildren(new ReverseAlphabeticalComparator()));
	...
	public void FilesInCodeDirectoryComparatorTest() {
		...
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)FilesystemApfs.getRootDir();
		String[] actual = APFSFileToString((LinkedList<ApfsFile>) root.findDirectoryByName("code").getFiles(new ReverseAlphabeticalComparator()));
		assertArrayEquals(expected, actual);
	}
	...
	public void FileInPicsDirectoryComparatorTest() {
		...
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)FilesystemApfs.getRootDir();
		String[] actual = APFSFileToString((LinkedList<ApfsFile>) root.findDirectoryByName("pics").getFiles(new ReverseAlphabeticalComparator()));
		assertArrayEquals(expected, actual);
	}
	...
	public void FileInRootDirectoryComparatorTest() {
		...
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)FilesystemApfs.getRootDir();
		String[] actual = ApfsEleToString((LinkedList<ApfsElement>) root.findDirectoryByName("root").getChildren(new ReverseAlphabeticalComparator()));
		assertArrayEquals(expected, actual);
	}
	...
	public void FileInHomeDirectoryComparatorTest() {
		...
		APFS FilesystemApfs = APFS.getAPFSFileSystem();
		ApfsDirectory root = (ApfsDirectory)FilesystemApfs.getRootDir();
		String[] actual = APFSFileToString((LinkedList<ApfsFile>) root.findDirectoryByName("home").getFiles(new ReverseAlphabeticalComparator()));
		assertArrayEquals(expected, actual);
	}
}
