...
class TimeStampComparatorTest {
	...
	public static void setUpFileStructure() {
		...
		ApfsDirectory applications = new ApfsDirectory(root, "applications", 0, localTime1, "Shreyansh", localTime1);
		ApfsDirectory home = new ApfsDirectory(root, "home", 0, localTime1, "Shreyansh", localTime1);
		ApfsDirectory code = new ApfsDirectory(home, "code", 0, localTime1, "Shreyansh", localTime1);
		ApfsDirectory pics = new ApfsDirectory(home, "pics", 0, localTime1, "Shreyansh", localTime1);
		ApfsFile a = new ApfsFile(applications, "a", 350, localTime2, "Shreyansh", localTime2);
		ApfsFile b = new ApfsFile(home, "b", 700, localTime2, "Shreyansh", localTime2);
		ApfsFile c = new ApfsFile(code, "c", 800, localTime1, "Shreyansh", localTime1);
		ApfsFile d = new ApfsFile(code, "d", 80, localTime2, "Shreyansh", localTime2);
		ApfsFile e = new ApfsFile(pics, "e", 700, localTime2, "Shreyansh", localTime2);
		ApfsFile f = new ApfsFile(pics, "f", 870, localTime1, "Shreyansh", localTime1);
		ApfsFile g = new ApfsFile(home, "g", 1, localTime2, "Shreyansh", localTime2);
		ApfsLink x = new ApfsLink(home, "x", 0, localTime2, "Shreyansh", localTime2, applications);
		ApfsLink y = new ApfsLink(code, "y", 0, localTime2, "Shreyansh", localTime2, a);
	}
